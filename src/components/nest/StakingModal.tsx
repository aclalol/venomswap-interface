...
export default function StakingModal({ isOpen, onDismiss, stakingInfo, userLiquidityUnstaked }: StakingModalProps) {
  ...
  const { parsedAmount, error } = useDerivedStakeInfo(typedValue, stakingInfo.amount, stakingInfo.amount)
  ...
  const [
    approval
    //  approveCallback
  ] = useApproveCallback(parsedAmount, masterBreeder?.address)
    ...
    <Modal isOpen={isOpen} onDismiss={wrappedOnDismiss} maxHeight={90}>
      {!attempting && !hash && !failed && (
        <ContentWrapper gap="lg">
          ...
          {/*  currency={stakingInfo.amount.token}*/}
          {/*  pair={dummyPair}*/}
          {/*  label={''}*/}
