...
export default function ModifiedStakingModal({ isOpen, onDismiss, stakingInfo }: StakingModalProps) {
  ...
  const { parsedAmount, error } = useDerivedUnstakeInfo(typedValue, stakingInfo.amount)
  ...
  // const dummyPair = new Pair(new TokenAmount(stakingInfo.tokens[0], '0'), new TokenAmount(stakingInfo.tokens[1],
  // '0'))
  ...
  // const maxAmountInput = maxAmountSpend(stakingInfo.amount)
    ...
    <Modal isOpen={isOpen} onDismiss={wrappedOnDismiss} maxHeight={90}>
      {!attempting && !hash && !failed && (
        <ContentWrapper gap="lg">
          ...
          {/*  currency={stakingInfo.amount}*/}
          {/*  pair={dummyPair}*/}
          {/*  label={''}*/}
          {/*  disableCurrencySelect={true}*/}
          {/*  overrideSelectedCurrencyBalance={stakingInfo.amount}*/}
